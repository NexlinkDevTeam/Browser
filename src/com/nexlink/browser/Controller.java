...
import com.nexlink.browser.IntentHandler.UrlData;
...
public class Controller
    ...
    /*
     * Update the favorites icon if the private browsing isn't whitelistEnabled and the
     * icon is valid.
     */
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // setEnabled() will decide whether an item is whitelistEnabled, which also means
