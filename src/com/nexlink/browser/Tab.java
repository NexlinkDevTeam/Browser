...
class Tab implements PictureListener {
    ...
    private static final boolean LOGD_ENABLED = com.nexlink.browser.Browser.LOGD_ENABLED;
    ...
    private final WebChromeClient mWebChromeClient = new WebChromeClient() {
         ...
         * console is whitelistEnabled in the about:debug options, to that console
         * also.
    ...
    /**
     * Return whether private browsing is whitelistEnabled for the main window of
     * this tab.
     * @return True if private browsing is whitelistEnabled.
     */
